...
Run date: 2026-09-17. Numbers are seed means from `results3/tables3.md` (5 seeds
for the temperature sweep and the ring, 3 seeds elsewhere). Design:
`docs/superpowers/specs/2026-09-17-supervision-bottleneck-design.md`. Theory:
`docs/task12_theory.md`. Reproduce with `scripts/run_task3.py` (18 min on CPU).
...
See `docs/task12_theory.md`. In brief: the loss depends on the input only through
