...
Brief: `TASK11.md` (claim 2 and the three tests that followed it). Part 1, recoverability, is
`docs/task11_theory.md` and `results11/REPORT11.md`. This part uses the **already-trained round-12
