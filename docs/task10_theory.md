...
Companion to `docs/task7_theory.md` (which defines ∼_coord, ∼_func and descent)
and to `results10/REPORT10.md`. This note states two claims formally, derives
