...
Carry p ∈ {0.05, 0.1, 0.2, 0.3} and plain p ∈ {0.1, 0.25} were added after the main grid showed the carry transition lies between p = 0 and 0.5 (`results15/fine/`). Prior weight at t = 16.
