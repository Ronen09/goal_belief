"""TASK3: the supervision bottleneck. Writes results3/.

    .venv/bin/python scripts/run_task3.py            # full (~30 min CPU)
    .venv/bin/python scripts/run_task3.py --quick    # smoke run
"""
...
from goalgeo import analysis as A, geometry as G, quotient as Qt, supervision as Sv, targets as T, models2 as M, plotting3 as P3
...
def main():
    ...
    ap = argparse.ArgumentParser(); ap.add_argument("--quick", action="store_true"); ap.add_argument("--out", default="results3")
    args = ap.parse_args()
