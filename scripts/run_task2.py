"""TASK2: policy-quotient versus occupancy geometry. Writes results2/.

    .venv/bin/python scripts/run_task2.py            # full (~25 min CPU)
    .venv/bin/python scripts/run_task2.py --quick    # smoke run
"""
...
from goalgeo import analysis as A, geometry as G, quotient as Qt, plotting as P, plotting2 as P2
...
def main():
    ap = argparse.ArgumentParser(); ap.add_argument("--quick", action="store_true"); ap.add_argument("--out", default="results2")
