"""TASK11 part 2: tables, prediction checks and figures from results11/causal/causal.json.

    .venv/bin/python scripts/task11_causal_tables.py
"""
...
from goalgeo import plotting11 as P11  # noqa: E402

OUT = Path("results11/causal")
...
def main():
    ...
    (OUT / "tables_causal.md").write_text(txt)
