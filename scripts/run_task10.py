"""TASK10: two experiments designed to falsify the claims of docs/task10_theory.md.
...
device. Measurement runs on the unstacked models in plain fp32.
    ...
    .venv/bin/python scripts/run_task10.py --exp all --steps 25000      # ~1.5 h on an A100
    .venv/bin/python scripts/run_task10.py --exp routing --quick        # smoke test
"""
...
def main():
    ...
    ap.add_argument("--out", default="results10"); ap.add_argument("--steps", type=int, default=DEFAULT_STEPS)
