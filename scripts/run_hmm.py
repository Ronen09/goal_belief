"""TASK4: one-step vs k-step vs sequential objectives on an HMM with one-step-equivalent beliefs.
    ...
    .venv/bin/python scripts/run_hmm.py [--quick] [--out results_hmm]
"""
...
def main():
    ap = argparse.ArgumentParser(); ap.add_argument("--quick", action="store_true"); ap.add_argument("--out", default="results_hmm")
