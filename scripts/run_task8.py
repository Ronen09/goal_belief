...
functionally equivalent models saved by TASK7 (plus six new delay-4 models).
    ...
    .venv/bin/python scripts/run_task8.py [--quick] [--jobs 6] [--out results8]
"""
...
def main():
    ap = argparse.ArgumentParser(); ap.add_argument("--quick", action="store_true"); ap.add_argument("--out", default="results8"); ap.add_argument("--jobs", type=int, default=6)
    ...
    from goalgeo.plotting8 import make_figures
    make_figures(R, out)
