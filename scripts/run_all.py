"""Run every phase of TASK.md and write results/ (figures, JSON, report tables).

    .venv/bin/python scripts/run_all.py            # full run
    .venv/bin/python scripts/run_all.py --quick    # smoke run (fewer seeds/steps)
"""
...
def write_report_tables(report, out: Path):
    """Auto-generated numeric tables (results/tables.md); the narrative report is hand-written."""
    L = A.HIDDEN_LAYERS
