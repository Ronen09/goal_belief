...
(docs/task13_window_theory.md).

    .venv/bin/python scripts/run_task13.py                  # ~25 min on CPU workers
    .venv/bin/python scripts/run_task13.py --measure-only
"""
...
WINDOWS = (1, 2, 4, 8, 25)
PAIRS = {"iid": "results11/causal/pairs_iid.npz", "channel": "results12/pairs.npz"}
N_PAIRS = 1000
...
def main():
    ...
    ap.add_argument("--out", default="results13")
