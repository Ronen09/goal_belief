...
batch 128. Numbers from `results_hmm/tables_hmm.md`; figures `hmm_key_pair.png`,
`hmm_rsa.png`. Design: `docs/superpowers/specs/2026-09-17-hmm-objectives-design.md`.
Reproduce with `scripts/run_hmm.py --device cuda` (about 5 minutes; CPU is as fast).
...
- `results_hmm/tables_hmm.md`: all numbers, both HMM variants, within-group
  distances, one-step-class compression and belief/2-step decoding.
- `results_hmm/results_hmm.json`: per-seed values.
