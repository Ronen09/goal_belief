...
(`results4/REPORT4.md`), which found that the geometric prominence of the
...
readout norm. Numbers from `results5/tables5.md`, per-run values and
checkpoint curves in `results5/results5.json`. Reproduce with
`scripts/run_task5.py --jobs 8`.
