...
Run date: 2026-09-17. Numbers are means over seeds from `results2/tables2.md`
(5 seeds per λ in the sweep, 3 warm-start chains, 3 seeds per extra environment)
and `results2/boltzmann/tables2.md`. Design: `docs/superpowers/specs/2026-09-17-policy-quotient-design.md`.
Reproduce with `scripts/run_task2.py` (8 min) and
`scripts/run_task2.py --targets boltzmann --sweep-only --out results2/boltzmann` (7 min).
