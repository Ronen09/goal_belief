...
(`results5/REPORT5.md`), which showed that the required logit gap
...
that landing point. Numbers from `results6/tables6.md`, per-run values and
checkpoint curves in `results6/results6.json`. Reproduce with
`scripts/run_task6.py --jobs 8`.
