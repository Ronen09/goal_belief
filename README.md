...
.venv/bin/python -m pytest            # 111 tests, ~70 s
...
| `tests/` | 111 tests: analytic checks (e.g. `ρ(g|s,a) = γ^T` exactly), geometry invariances, model/patching identities, switch-env boundary, linearised steering threshold exact at the last layer |
