...
Numbers from `results4/tables4.md`, per-run values in `results4/results4.json`.
Design: `docs/superpowers/specs/2026-09-18-geometric-prominence-design.md`.
Reproduce with `scripts/run_task4.py --jobs 8 --grid --dynamics`.
