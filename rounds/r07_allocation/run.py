...
readout learning-rate ratio, readout initialisation scale, and the control branch's contrast.
    ...
    .venv/bin/python rounds/r07_allocation/run.py [--quick] [--jobs 8] [--out results6]
"""
...
def main():
    ...
    ap.add_argument("--quick", action="store_true"); ap.add_argument("--out", default="rounds/r07_allocation"); ap.add_argument("--jobs", type=int, default=8)
