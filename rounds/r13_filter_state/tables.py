"""TASK12 (round 13): tables, prediction checks and figures from rounds/r13_filter_state/results12.json.

    .venv/bin/python rounds/r13_filter_state/tables.py
"""
...
OUT = Path("rounds/r13_filter_state")
...
def goal_only_reference():
    ...
    p = Path("rounds/r12_hidden_goal/causal/causal.json")
    if not p.exists():
        return {}
