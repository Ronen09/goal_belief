...
`rounds/r04_hmm_objectives/REPORT.md`), where a GRU trained on next-token prediction kept
...
## Experiments (`rounds/r05_prominence/run.py`, results in `rounds/r05_prominence/`)
...
(5) delay sweep. Outputs: `tables.md`, `results4.json`, `REPORT.md`.
