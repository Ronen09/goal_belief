...
(rounds/r16_kv_dropout/THEORY.md).

    .venv/bin/python rounds/r16_kv_dropout/run.py                 # ~30 min (GPU for plain, CPU workers for carry)
    .venv/bin/python rounds/r16_kv_dropout/run.py --measure-only
"""
...
def main():
    ...
    ap.add_argument("--out", default="rounds/r16_kv_dropout")
