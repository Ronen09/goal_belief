...
Date: 2026-09-17. Requirements: `rounds/r03_supervision/BRIEF.md`. Builds on rounds 1–2.

## 1. Question

Does hidden geometry preserve exactly the distinctions contained in the training
target? Deliverable: `rounds/r03_supervision/run.py` writing `rounds/r03_supervision/` (figures, JSON,
`tables.md`) and `rounds/r03_supervision/REPORT.md` including the theoretical account (Task 12).
...
- `rounds/r03_supervision/plots.py`, `rounds/r03_supervision/run.py`.
