"""TASK14 (round 15): tables, prediction checks and figure from rounds/r15_prior_vs_recompute/results14.json.

    .venv/bin/python rounds/r15_prior_vs_recompute/tables.py
"""
...
OUT = Path("rounds/r15_prior_vs_recompute")
...
def tables(d: D) -> str:
    ...
    L_ += ["", "## 5. Post hoc (not pre-registered): calibrated λ and the pure-recomputation prediction", "",
           ...
           "x_{t+1}), i.e. what pure recomputation from tokens predicts (rounds/r15_prior_vs_recompute/recompute.py).", "",
...
def main():
    ...
    txt += "\n## 4. Pre-registered predictions (rounds/r15_prior_vs_recompute/THEORY.md §5)\n\n| prediction | held | numbers |\n|---|---|---|\n"
