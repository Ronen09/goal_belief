"""TASK14 (round 15): prior vs recomputation through the K/V cache (rounds/r15_prior_vs_recompute/THEORY.md).

    .venv/bin/python rounds/r15_prior_vs_recompute/run.py                  # train 12 next-token transformers + measure
    .venv/bin/python rounds/r15_prior_vs_recompute/run.py --measure-only
"""
...
def main():
    ...
    ap.add_argument("--out", default="rounds/r15_prior_vs_recompute")
