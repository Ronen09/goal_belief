...
which keeps A's raw token at position t. Writes rounds/r15_prior_vs_recompute/recompute_prediction.json."""
...
json.dump(out,open("rounds/r15_prior_vs_recompute/recompute_prediction.json","w"),indent=1)
