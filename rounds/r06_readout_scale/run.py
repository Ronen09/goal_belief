...
the hidden separation at t*-1 compensates as 1/c.
    ...
    .venv/bin/python rounds/r06_readout_scale/run.py [--quick] [--jobs 8] [--out results5]
"""
...
def main():
    ...
    ap.add_argument("--quick", action="store_true"); ap.add_argument("--out", default="rounds/r06_readout_scale"); ap.add_argument("--jobs", type=int, default=8)
