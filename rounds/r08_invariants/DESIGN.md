...
Date: 2026-09-18. Follows TASK4–6 (`rounds/r05_prominence/REPORT.md`, `rounds/r06_readout_scale/REPORT.md`,
`rounds/r07_allocation/REPORT.md`): the required logit gap Δℓ = g·D·cos θ is met by different
...
## Models (`rounds/r08_invariants/run.py`, weights saved to `rounds/r08_invariants/models/`)
...
Outputs: `rounds/r08_invariants/tables.md`, `rounds/r08_invariants/results7.json`, `rounds/r08_invariants/REPORT.md`.
