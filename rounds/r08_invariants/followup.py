...
sys.path.insert(0, str(Path(__file__).resolve().parent)); from run import conditions, eval_indices, EPS_KL

out = Path("rounds/r08_invariants"); R = json.load(open(out / "results7.json"))
