...
(rounds/r12_hidden_goal/causal/THEORY.md). No training.

    .venv/bin/python rounds/r12_hidden_goal/causal_run.py            # ~15 min on 64 CPU workers
    .venv/bin/python rounds/r12_hidden_goal/causal_run.py --quick    # 2 models, few pairs
"""
...
def main():
    ...
    ap.add_argument("--out", default="rounds/r12_hidden_goal/causal")
    ap.add_argument("--models", default="rounds/r12_hidden_goal/models")
