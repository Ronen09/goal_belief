...
them with the same probes. Output: rounds/r12_hidden_goal/long/results11.json, rounds/r12_hidden_goal/long/models/.

    .venv/bin/python rounds/r12_hidden_goal/followup.py
"""
...
import run as R11  # noqa: E402
from goalgeo import belief_train as BT  # noqa: E402


def main():
    out = Path("rounds/r12_hidden_goal/long")
    jobs = []
    for arch in ("tfm", "gru"):
