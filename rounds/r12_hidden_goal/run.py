...
posterior log-odds (rounds/r12_hidden_goal/THEORY.md).

    .venv/bin/python rounds/r12_hidden_goal/run.py                  # train + measure, ~25 min
    .venv/bin/python rounds/r12_hidden_goal/run.py --measure-only   # re-measure from rounds/r12_hidden_goal/models
    .venv/bin/python rounds/r12_hidden_goal/run.py --quick --out rounds/r12_hidden_goal/_smoke
"""
...
def main():
    ...
    ap.add_argument("--out", default="rounds/r12_hidden_goal")
