"""TASK13 (round 14): tables, prediction checks and figures from rounds/r14_window_carry/results13.json.

    .venv/bin/python rounds/r14_window_carry/tables.py
"""
...
OUT = Path("rounds/r14_window_carry")
WINDOWS = (1, 2, 4, 8, 25)
...
def main():
    ...
    txt += "\n## 4. Pre-registered predictions (rounds/r14_window_carry/THEORY.md §4)\n\n| prediction | held | numbers |\n|---|---|---|\n"
