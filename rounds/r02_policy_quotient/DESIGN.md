...
Date: 2026-09-17. Requirements: `rounds/r02_policy_quotient/BRIEF.md`. Builds on the `goalgeo` package and
the findings in `rounds/r01_occupancy/REPORT.md`.
...
geometry (H3)? The deliverable is `rounds/r02_policy_quotient/run.py` writing `rounds/r02_policy_quotient/`
(figures, JSON, `tables.md`) plus `rounds/r02_policy_quotient/REPORT.md`.
...
- `rounds/r02_policy_quotient/run.py`: Tasks 1–10, writes `rounds/r02_policy_quotient/`.
...
Same as `rounds/r02_policy_quotient/BRIEF.md` "Success Criteria"; the report states per criterion whether it
