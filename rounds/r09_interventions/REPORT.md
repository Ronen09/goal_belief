...
on the TASK7 models). Definitions in `rounds/r08_invariants/THEORY.md`; numbers from
`rounds/r09_interventions/tables.md`, arrays in `rounds/r09_interventions/results8.json`, figures
`fig1_intervention_equivalence.png`, `fig2_on_off_manifold.png`,
`fig3_propagation_depth.png`. Reproduce with `rounds/r09_interventions/run.py --jobs 6`
(needs `rounds/r08_invariants/models/`).
